...
public class Factorial extends AbstractAction {
	...
	public Data enact(Data data, Bindings bindings)
			throws Exceptional, Failed {
		return ((new Hence((new Then((new And(((new AbstractAction() {
		public Data enact(Data data, Bindings bindings)
				throws Exceptional, Failed {
			return bindings;
		}
	...
	})))),(new AndExceptionally((new Hence((new Then((new And(((new AbstractAction() {
		public Data enact(Data data, Bindings bindings)
				throws Exceptional, Failed {
			return bindings;
		}
		...
		public Data enact(Data data, Bindings bindings)
				throws Exceptional, Failed {
			return this.mergeData(((new AbstractAction() {
		public Data enact(Data data, Bindings bindings)
				throws Exceptional, Failed {
		...
		public Data enact(Data data, Bindings bindings)
				throws Exceptional, Failed {
			return new Then((new Then((new And((new Then((new And((new Then((new Then((new Then((new And(((new AbstractAction() {
		public Data enact(Data data, Bindings bindings)
				throws Exceptional, Failed {
			return bindings;
		}
	...
	})))))),(new And((new Exceptionally(((new AbstractAction() {
		public Data enact(Data data, Bindings bindings)
				throws Exceptional, Failed {
	...
	})))))),(new Otherwise((new Otherwise((new AndThen((new Then((new Then((new And((new Then(((new AbstractAction() {
		public Data enact(Data data, Bindings bindings)
				throws Exceptional, Failed {
			return ((Data)data);
		}
	...
	(Storable)(data.getElt(2)));
	...
	})))),(new AndThen((new AndExceptionally((new Hence((new Then((new And(((new AbstractAction() {
		public Data enact(Data data, Bindings bindings)
				throws Exceptional, Failed {
			return bindings;
		}
		...
		public Data enact(Data data, Bindings bindings)
				throws Exceptional, Failed {
			return ((Int)data.getElt(1)).plus((Int)data.getElt(2));
		}
	})))))))),((new AbstractAction() {
		public Data enact(Data data, Bindings bindings)
				throws Exceptional, Failed {
	...
	})))),(new Then((new Then((new And((new Then((new And((new Then((new Then((new Then((new And(((new AbstractAction() {
		public Data enact(Data data, Bindings bindings)
				throws Exceptional, Failed {
			return bindings;
		}
