...
typedef struct ATerm _AIL_Statements;
...
/*}}}  */
/*{{{  AIL_Statements AIL_StatementsFromTerm(ATerm t) */

AIL_Statements AIL_StatementsFromTerm(ATerm t)
{
  return (AIL_Statements)t;
}

/*}}}  */
/*{{{  ATerm AIL_StatementsToTerm(AIL_Statements arg) */
...
/*}}}  */
/*{{{  AIL_Program AIL_makeProgramDefault(AIL_Layout wsAfterBraceOpen, AIL_Statements stats, AIL_Layout wsAfterStats, AIL_Layout wsAfterBraceClose, AIL_Layout wsAfterBracketOpen, AIL_ATerm label, AIL_Layout wsAfterLabel, AIL_Layout wsAfterComma, AIL_ATerm ann, AIL_Layout wsAfterAnn, AIL_Layout wsAfterBracketClose) */

AIL_Program AIL_makeProgramDefault(AIL_Layout wsAfterBraceOpen, AIL_Statements stats, AIL_Layout wsAfterStats, AIL_Layout wsAfterBraceClose, AIL_Layout wsAfterBracketOpen, AIL_ATerm label, AIL_Layout wsAfterLabel, AIL_Layout wsAfterComma, AIL_ATerm ann, AIL_Layout wsAfterAnn, AIL_Layout wsAfterBracketClose)
{
  return (AIL_Program)(ATerm)ATmakeAppl2(AIL_afun0, (ATerm)ATmakeAppl3(AIL_afun1, (ATerm)ATinsert(ATinsert(ATinsert(ATinsert(ATinsert(ATinsert(ATinsert(ATinsert(ATinsert(ATinsert(ATinsert(ATinsert(ATinsert(ATinsert(ATinsert(ATinsert(ATinsert(ATinsert(ATmakeList1((ATerm)ATmakeAppl1(AIL_afun2, (ATerm)ATmakeAppl0(AIL_afun34))), (ATerm)ATmakeAppl1(AIL_afun4, (ATerm)ATmakeAppl1(AIL_afun5, (ATerm)ATmakeAppl0(AIL_afun6)))), (ATerm)ATmakeAppl1(AIL_afun2, (ATerm)ATmakeAppl0(AIL_afun3))), (ATerm)ATmakeAppl1(AIL_afun4, (ATerm)ATmakeAppl1(AIL_afun5, (ATerm)ATmakeAppl0(AIL_afun6)))), (ATerm)ATmakeAppl1(AIL_afun4, (ATerm)ATmakeAppl1(AIL_afun8, (ATerm)ATmakeAppl0(AIL_afun29)))), (ATerm)ATmakeAppl1(AIL_afun4, (ATerm)ATmakeAppl1(AIL_afun5, (ATerm)ATmakeAppl0(AIL_afun6)))), (ATerm)ATmakeAppl1(AIL_afun2, (ATerm)ATmakeAppl0(AIL_afun35))), (ATerm)ATmakeAppl1(AIL_afun4, (ATerm)ATmakeAppl1(AIL_afun5, (ATerm)ATmakeAppl0(AIL_afun6)))), (ATerm)ATmakeAppl1(AIL_afun4, (ATerm)ATmakeAppl1(AIL_afun8, (ATerm)ATmakeAppl0(AIL_afun29)))), (ATerm)ATmakeAppl1(AIL_afun4, (ATerm)ATmakeAppl1(AIL_afun5, (ATerm)ATmakeAppl0(AIL_afun6)))), (ATerm)ATmakeAppl1(AIL_afun2, (ATerm)ATmakeAppl0(AIL_afun10))), (ATerm)ATmakeAppl1(AIL_afun4, (ATerm)ATmakeAppl1(AIL_afun5, (ATerm)ATmakeAppl0(AIL_afun6)))), (ATerm)ATmakeAppl1(AIL_afun2, (ATerm)ATmakeAppl0(AIL_afun36))), (ATerm)ATmakeAppl1(AIL_afun4, (ATerm)ATmakeAppl1(AIL_afun5, (ATerm)ATmakeAppl0(AIL_afun6)))), (ATerm)ATmakeAppl1(AIL_afun2, (ATerm)ATmakeAppl0(AIL_afun34))), (ATerm)ATmakeAppl1(AIL_afun4, (ATerm)ATmakeAppl1(AIL_afun5, (ATerm)ATmakeAppl0(AIL_afun6)))), (ATerm)ATmakeAppl1(AIL_afun4, (ATerm)ATmakeAppl1(AIL_afun8, (ATerm)ATmakeAppl0(AIL_afun37)))), (ATerm)ATmakeAppl1(AIL_afun4, (ATerm)ATmakeAppl1(AIL_afun5, (ATerm)ATmakeAppl0(AIL_afun6)))), (ATerm)ATmakeAppl1(AIL_afun2, (ATerm)ATmakeAppl0(AIL_afun36))), (ATerm)ATmakeAppl1(AIL_afun4, (ATerm)ATmakeAppl1(AIL_afun8, (ATerm)ATmakeAppl0(AIL_afun27))), (ATerm)ATmakeAppl0(AIL_afun12)), (ATerm)ATinsert(ATinsert(ATinsert(ATinsert(ATinsert(ATinsert(ATinsert(ATinsert(ATinsert(ATinsert(ATinsert(ATinsert(ATinsert(ATinsert(ATinsert(ATinsert(ATinsert(ATinsert(ATmakeList1((ATerm)ATmakeAppl1(AIL_afun2, (ATerm)ATmakeAppl0(AIL_afun34))), (ATerm)wsAfterBracketClose), (ATerm)ATmakeAppl1(AIL_afun2, (ATerm)ATmakeAppl0(AIL_afun3))), (ATerm)wsAfterAnn), (ATerm)ann), (ATerm)wsAfterComma), (ATerm)ATmakeAppl1(AIL_afun2, (ATerm)ATmakeAppl0(AIL_afun35))), (ATerm)wsAfterLabel), (ATerm)label), (ATerm)wsAfterBracketOpen), (ATerm)ATmakeAppl1(AIL_afun2, (ATerm)ATmakeAppl0(AIL_afun10))), (ATerm)wsAfterBraceOpen), (ATerm)ATmakeAppl1(AIL_afun2, (ATerm)ATmakeAppl0(AIL_afun36))), (ATerm)wsAfterBraceClose), (ATerm)ATmakeAppl1(AIL_afun2, (ATerm)ATmakeAppl0(AIL_afun34))), (ATerm)wsAfterStats), (ATerm)stats), (ATerm)wsAfterBraceOpen), (ATerm)ATmakeAppl1(AIL_afun2, (ATerm)ATmakeAppl0(AIL_afun36))));
}

/*}}}  */
/*{{{  AIL_Statements AIL_makeStatementsDefault(AIL_StatementList list) */

AIL_Statements AIL_makeStatementsDefault(AIL_StatementList list)
{
  return (AIL_Statements)(ATerm)ATmakeAppl2(AIL_afun0, (ATerm)ATmakeAppl3(AIL_afun1, (ATerm)ATmakeList1((ATerm)ATmakeAppl1(AIL_afun4, (ATerm)ATmakeAppl1(AIL_afun7, (ATerm)ATmakeAppl1(AIL_afun8, (ATerm)ATmakeAppl0(AIL_afun23))))), (ATerm)ATmakeAppl1(AIL_afun4, (ATerm)ATmakeAppl1(AIL_afun8, (ATerm)ATmakeAppl0(AIL_afun37))), (ATerm)ATmakeAppl0(AIL_afun12)), (ATerm)ATmakeList1((ATerm)ATmakeAppl2(AIL_afun0, (ATerm)ATmakeAppl1(AIL_afun13, (ATerm)ATmakeAppl1(AIL_afun4, (ATerm)ATmakeAppl1(AIL_afun7, (ATerm)ATmakeAppl1(AIL_afun8, (ATerm)ATmakeAppl0(AIL_afun23))))), (ATerm)list)));
}
...
ATbool AIL_isEqualStatements(AIL_Statements arg0, AIL_Statements arg1)
{
  return ATisEqual((ATerm)arg0, (ATerm)arg1);
}
...
#ifndef DISABLE_DYNAMIC_CHECKING
  assert(arg != NULL);
  assert(ATmatchTerm((ATerm)arg, AIL_patternProgramDefault, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL));
#endif
  return ATtrue;
}
...
ATbool AIL_hasProgramWsAfterBraceOpen(AIL_Program arg)
{
  ...
  else if (AIL_isProgramDefault(arg)) {
    return ATtrue;
  }
  return ATfalse;
}
...
AIL_Program AIL_setProgramWsAfterBraceOpen(AIL_Program arg, AIL_Layout wsAfterBraceOpen)
{
  if (AIL_isProgramDefault(arg)) {
    ...
    return (AIL_Program)ATsetArgument((ATermAppl)arg, (ATerm)ATreplace((ATermList)ATgetArgument((ATermAppl)arg, 1), (ATerm)wsAfterBraceOpen, 7), 1);
  }
...
/*}}}  */
/*{{{  ATbool AIL_hasProgramStats(AIL_Program arg) */
...
/*}}}  */
/*{{{  AIL_Statements AIL_getProgramStats(AIL_Program arg) */

AIL_Statements AIL_getProgramStats(AIL_Program arg)
{
  
    return (AIL_Statements)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 2);
}

/*}}}  */
/*{{{  AIL_Program AIL_setProgramStats(AIL_Program arg, AIL_Statements stats) */

AIL_Program AIL_setProgramStats(AIL_Program arg, AIL_Statements stats)
{
  if (AIL_isProgramDefault(arg)) {
    return (AIL_Program)ATsetArgument((ATermAppl)arg, (ATerm)ATreplace((ATermList)ATgetArgument((ATermAppl)arg, 1), (ATerm)stats, 2), 1);
  }

  ATabort("Program has no Stats: %t\n", arg);
  return (AIL_Program)NULL;
}

/*}}}  */
/*{{{  ATbool AIL_hasProgramWsAfterStats(AIL_Program arg) */
...
/*}}}  */
/*{{{  AIL_Layout AIL_getProgramWsAfterStats(AIL_Program arg) */
...
/*}}}  */
/*{{{  AIL_Program AIL_setProgramWsAfterStats(AIL_Program arg, AIL_Layout wsAfterStats) */

AIL_Program AIL_setProgramWsAfterStats(AIL_Program arg, AIL_Layout wsAfterStats)
{
  if (AIL_isProgramDefault(arg)) {
    return (AIL_Program)ATsetArgument((ATermAppl)arg, (ATerm)ATreplace((ATermList)ATgetArgument((ATermAppl)arg, 1), (ATerm)wsAfterStats, 3), 1);
  }

  ATabort("Program has no WsAfterStats: %t\n", arg);
  return (AIL_Program)NULL;
}
...
/*}}}  */
/*{{{  ATbool AIL_hasProgramWsAfterBracketOpen(AIL_Program arg) */
...
/*}}}  */
/*{{{  AIL_Layout AIL_getProgramWsAfterBracketOpen(AIL_Program arg) */

AIL_Layout AIL_getProgramWsAfterBracketOpen(AIL_Program arg)
{
  
    return (AIL_Layout)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 9);
}

/*}}}  */
/*{{{  AIL_Program AIL_setProgramWsAfterBracketOpen(AIL_Program arg, AIL_Layout wsAfterBracketOpen) */

AIL_Program AIL_setProgramWsAfterBracketOpen(AIL_Program arg, AIL_Layout wsAfterBracketOpen)
{
  if (AIL_isProgramDefault(arg)) {
    return (AIL_Program)ATsetArgument((ATermAppl)arg, (ATerm)ATreplace((ATermList)ATgetArgument((ATermAppl)arg, 1), (ATerm)wsAfterBracketOpen, 9), 1);
  }

  ATabort("Program has no WsAfterBracketOpen: %t\n", arg);
  return (AIL_Program)NULL;
}

/*}}}  */
/*{{{  ATbool AIL_hasProgramLabel(AIL_Program arg) */
...
/*}}}  */
/*{{{  AIL_ATerm AIL_getProgramLabel(AIL_Program arg) */

AIL_ATerm AIL_getProgramLabel(AIL_Program arg)
{
  
    return (AIL_ATerm)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 10);
}

/*}}}  */
/*{{{  AIL_Program AIL_setProgramLabel(AIL_Program arg, AIL_ATerm label) */

AIL_Program AIL_setProgramLabel(AIL_Program arg, AIL_ATerm label)
{
  if (AIL_isProgramDefault(arg)) {
    return (AIL_Program)ATsetArgument((ATermAppl)arg, (ATerm)ATreplace((ATermList)ATgetArgument((ATermAppl)arg, 1), (ATerm)label, 10), 1);
  }

  ATabort("Program has no Label: %t\n", arg);
  return (AIL_Program)NULL;
}

/*}}}  */
/*{{{  ATbool AIL_hasProgramWsAfterLabel(AIL_Program arg) */
...
/*}}}  */
/*{{{  AIL_Layout AIL_getProgramWsAfterLabel(AIL_Program arg) */

AIL_Layout AIL_getProgramWsAfterLabel(AIL_Program arg)
{
  
    return (AIL_Layout)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 11);
}

/*}}}  */
/*{{{  AIL_Program AIL_setProgramWsAfterLabel(AIL_Program arg, AIL_Layout wsAfterLabel) */

AIL_Program AIL_setProgramWsAfterLabel(AIL_Program arg, AIL_Layout wsAfterLabel)
{
  if (AIL_isProgramDefault(arg)) {
    return (AIL_Program)ATsetArgument((ATermAppl)arg, (ATerm)ATreplace((ATermList)ATgetArgument((ATermAppl)arg, 1), (ATerm)wsAfterLabel, 11), 1);
  }

  ATabort("Program has no WsAfterLabel: %t\n", arg);
  return (AIL_Program)NULL;
}

/*}}}  */
/*{{{  ATbool AIL_hasProgramWsAfterComma(AIL_Program arg) */
...
/*}}}  */
/*{{{  AIL_Layout AIL_getProgramWsAfterComma(AIL_Program arg) */

AIL_Layout AIL_getProgramWsAfterComma(AIL_Program arg)
{
  
    return (AIL_Layout)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 13);
}

/*}}}  */
/*{{{  AIL_Program AIL_setProgramWsAfterComma(AIL_Program arg, AIL_Layout wsAfterComma) */

AIL_Program AIL_setProgramWsAfterComma(AIL_Program arg, AIL_Layout wsAfterComma)
{
  if (AIL_isProgramDefault(arg)) {
    return (AIL_Program)ATsetArgument((ATermAppl)arg, (ATerm)ATreplace((ATermList)ATgetArgument((ATermAppl)arg, 1), (ATerm)wsAfterComma, 13), 1);
  }

  ATabort("Program has no WsAfterComma: %t\n", arg);
  return (AIL_Program)NULL;
}
...
/*}}}  */
/*{{{  AIL_ATerm AIL_getProgramAnn(AIL_Program arg) */

AIL_ATerm AIL_getProgramAnn(AIL_Program arg)
{
  
    return (AIL_ATerm)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 14);
}

/*}}}  */
/*{{{  AIL_Program AIL_setProgramAnn(AIL_Program arg, AIL_ATerm ann) */

AIL_Program AIL_setProgramAnn(AIL_Program arg, AIL_ATerm ann)
{
  if (AIL_isProgramDefault(arg)) {
    return (AIL_Program)ATsetArgument((ATermAppl)arg, (ATerm)ATreplace((ATermList)ATgetArgument((ATermAppl)arg, 1), (ATerm)ann, 14), 1);
  }
...
/*}}}  */
/*{{{  ATbool AIL_hasProgramWsAfterAnn(AIL_Program arg) */
...
/*}}}  */
/*{{{  AIL_Layout AIL_getProgramWsAfterAnn(AIL_Program arg) */

AIL_Layout AIL_getProgramWsAfterAnn(AIL_Program arg)
{
  
    return (AIL_Layout)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 15);
}

/*}}}  */
/*{{{  AIL_Program AIL_setProgramWsAfterAnn(AIL_Program arg, AIL_Layout wsAfterAnn) */

AIL_Program AIL_setProgramWsAfterAnn(AIL_Program arg, AIL_Layout wsAfterAnn)
{
  if (AIL_isProgramDefault(arg)) {
    return (AIL_Program)ATsetArgument((ATermAppl)arg, (ATerm)ATreplace((ATermList)ATgetArgument((ATermAppl)arg, 1), (ATerm)wsAfterAnn, 15), 1);
  }

  ATabort("Program has no WsAfterAnn: %t\n", arg);
  return (AIL_Program)NULL;
}

/*}}}  */
/*{{{  ATbool AIL_hasProgramWsAfterBracketClose(AIL_Program arg) */
...
/*}}}  */
/*{{{  AIL_Layout AIL_getProgramWsAfterBracketClose(AIL_Program arg) */

AIL_Layout AIL_getProgramWsAfterBracketClose(AIL_Program arg)
{
  
    return (AIL_Layout)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 17);
}

/*}}}  */
/*{{{  AIL_Program AIL_setProgramWsAfterBracketClose(AIL_Program arg, AIL_Layout wsAfterBracketClose) */

AIL_Program AIL_setProgramWsAfterBracketClose(AIL_Program arg, AIL_Layout wsAfterBracketClose)
{
  if (AIL_isProgramDefault(arg)) {
    return (AIL_Program)ATsetArgument((ATermAppl)arg, (ATerm)ATreplace((ATermList)ATgetArgument((ATermAppl)arg, 1), (ATerm)wsAfterBracketClose, 17), 1);
  }

  ATabort("Program has no WsAfterBracketClose: %t\n", arg);
  return (AIL_Program)NULL;
}
...
/*}}}  */
/*{{{  AIL_Statements accessors */

/*{{{  ATbool AIL_isValidStatements(AIL_Statements arg) */

ATbool AIL_isValidStatements(AIL_Statements arg)
{
  if (AIL_isStatementsDefault(arg)) {
    return ATtrue;
  }
  return ATfalse;
}
...
/*}}}  */
/*{{{  inline ATbool AIL_isStatementsDefault(AIL_Statements arg) */

inline ATbool AIL_isStatementsDefault(AIL_Statements arg)
{
#ifndef DISABLE_DYNAMIC_CHECKING
  assert(arg != NULL);
  assert(ATmatchTerm((ATerm)arg, AIL_patternStatementsDefault, NULL));
#endif
  return ATtrue;
}

/*}}}  */
/*{{{  ATbool AIL_hasStatementsList(AIL_Statements arg) */
...
/*}}}  */
/*{{{  AIL_StatementList AIL_getStatementsList(AIL_Statements arg) */

AIL_StatementList AIL_getStatementsList(AIL_Statements arg)
{
  
    return (AIL_StatementList)ATgetArgument((ATermAppl)ATgetFirst((ATermList)ATgetArgument((ATermAppl)arg, 1)), 1);
}

/*}}}  */
/*{{{  AIL_Statements AIL_setStatementsList(AIL_Statements arg, AIL_StatementList list) */

AIL_Statements AIL_setStatementsList(AIL_Statements arg, AIL_StatementList list)
{
  if (AIL_isStatementsDefault(arg)) {
    return (AIL_Statements)ATsetArgument((ATermAppl)arg, (ATerm)ATreplace((ATermList)ATgetArgument((ATermAppl)arg, 1), (ATerm)ATsetArgument((ATermAppl)ATgetFirst((ATermList)ATgetArgument((ATermAppl)arg, 1)), (ATerm)list, 1), 0), 1);
  }

  ATabort("Statements has no List: %t\n", arg);
  return (AIL_Statements)NULL;
}
...
/*}}}  */
/*{{{  AIL_Program AIL_visitProgram(AIL_Program arg, AIL_Layout (*acceptWsAfterBraceOpen)(AIL_Layout), AIL_Statements (*acceptStats)(AIL_Statements), AIL_Layout (*acceptWsAfterStats)(AIL_Layout), AIL_Layout (*acceptWsAfterBraceClose)(AIL_Layout), AIL_Layout (*acceptWsAfterBracketOpen)(AIL_Layout), AIL_ATerm (*acceptLabel)(AIL_ATerm), AIL_Layout (*acceptWsAfterLabel)(AIL_Layout), AIL_Layout (*acceptWsAfterComma)(AIL_Layout), AIL_ATerm (*acceptAnn)(AIL_ATerm), AIL_Layout (*acceptWsAfterAnn)(AIL_Layout), AIL_Layout (*acceptWsAfterBracketClose)(AIL_Layout)) */
...
AIL_Program AIL_visitProgram(AIL_Program arg, AIL_Layout (*acceptWsAfterBraceOpen)(AIL_Layout), AIL_Statements (*acceptStats)(AIL_Statements), AIL_Layout (*acceptWsAfterStats)(AIL_Layout), AIL_Layout (*acceptWsAfterBraceClose)(AIL_Layout), AIL_Layout (*acceptWsAfterBracketOpen)(AIL_Layout), AIL_ATerm (*acceptLabel)(AIL_ATerm), AIL_Layout (*acceptWsAfterLabel)(AIL_Layout), AIL_Layout (*acceptWsAfterComma)(AIL_Layout), AIL_ATerm (*acceptAnn)(AIL_ATerm), AIL_Layout (*acceptWsAfterAnn)(AIL_Layout), AIL_Layout (*acceptWsAfterBracketClose)(AIL_Layout))
{
  if (AIL_isProgramDefault(arg)) {
    return AIL_makeProgramDefault(
        ...
        acceptStats ? acceptStats(AIL_getProgramStats(arg)) : AIL_getProgramStats(arg),
        acceptWsAfterStats ? acceptWsAfterStats(AIL_getProgramWsAfterStats(arg)) : AIL_getProgramWsAfterStats(arg),
        acceptWsAfterBraceClose ? acceptWsAfterBraceClose(AIL_getProgramWsAfterBraceClose(arg)) : AIL_getProgramWsAfterBraceClose(arg),
        acceptWsAfterBracketOpen ? acceptWsAfterBracketOpen(AIL_getProgramWsAfterBracketOpen(arg)) : AIL_getProgramWsAfterBracketOpen(arg),
        acceptLabel ? acceptLabel(AIL_getProgramLabel(arg)) : AIL_getProgramLabel(arg),
        acceptWsAfterLabel ? acceptWsAfterLabel(AIL_getProgramWsAfterLabel(arg)) : AIL_getProgramWsAfterLabel(arg),
        acceptWsAfterComma ? acceptWsAfterComma(AIL_getProgramWsAfterComma(arg)) : AIL_getProgramWsAfterComma(arg),
        acceptAnn ? acceptAnn(AIL_getProgramAnn(arg)) : AIL_getProgramAnn(arg),
        acceptWsAfterAnn ? acceptWsAfterAnn(AIL_getProgramWsAfterAnn(arg)) : AIL_getProgramWsAfterAnn(arg),
        acceptWsAfterBracketClose ? acceptWsAfterBracketClose(AIL_getProgramWsAfterBracketClose(arg)) : AIL_getProgramWsAfterBracketClose(arg));
  }
...
/*}}}  */
/*{{{  AIL_Statements AIL_visitStatements(AIL_Statements arg, AIL_StatementList (*acceptList)(AIL_StatementList)) */

AIL_Statements AIL_visitStatements(AIL_Statements arg, AIL_StatementList (*acceptList)(AIL_StatementList))
{
  if (AIL_isStatementsDefault(arg)) {
    return AIL_makeStatementsDefault(
        acceptList ? acceptList(AIL_getStatementsList(arg)) : AIL_getStatementsList(arg));
  }
  ATabort("not a Statements: %t\n", arg);
  return (AIL_Statements)NULL;
}
