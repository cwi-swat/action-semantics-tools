 ...
 */
public class FibIter extends AbstractEnactable {
    public static void main(String args[]) {
	DataFactory f = new ajc.data.pure.PureFactory();
	Store.initStore(f);
	Enactable fib = new FibIter(f);
	try {
     ...
     */
    public FibIter(DataFactory factory) {
     ...
     *@exception  Exceptional  Description of the Exception
     *@exception  Failed       Description of the Exception
     *@exception  Unfold       Description of the Exception
     */
    ...
    private Data then$112(Data data,
            Bindings bindings)
             throws Exceptional, Failed, Unfold {
	////System.out.println(data.toString() + bindings.toString());
    ...
    private Data unfolding$110(Data data,
            Bindings bindings)
             throws Exceptional, Failed {
	//System.out.println("before unfolding: " + data);
        while (true) {
            try {
                return then$112(data, bindings);
            } catch (Unfold u) {
                data = u.getData();
            }
        }
